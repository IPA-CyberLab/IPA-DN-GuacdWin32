...
/* ./.libs/lt-faac.c - temporary wrapper executable for .libs/faac
   Generated by libtool (GNU libtool) 2.4.6

   The faac program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "faac"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# faac - temporary wrapper script for .libs/faac\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The faac program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"faac:faac:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"faac:faac:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"faac:faac:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
