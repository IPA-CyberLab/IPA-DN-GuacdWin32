...
/* ./.libs/lt-uuid.c - temporary wrapper executable for .libs/uuid
   Generated by ltmain.sh (GNU libtool) 2.2.4

   The uuid program cannot be directly executed until all the libtool
   libraries that it depends on are installed.

   This wrapper executable should never be moved out of the build directory.
   If it is, it will not operate correctly.

   Currently, it simply execs the wrapper *script* "/bin/sh uuid",
   but could eventually absorb all of the scripts functionality and
   exec .libs/uuid directly.
*/
#include <stdio.h>
#include <stdlib.h>
#ifdef _MSC_VER
...
static const char *script_text =
  "#! /bin/sh\n"
  "\n"
  "# uuid - temporary wrapper script for .libs/uuid\n"
  "# Generated by ltmain.sh (GNU libtool) 2.2.4\n"
  "#\n"
  "# The uuid program cannot be directly executed until all the libtool\n"
  "# libraries that it depends on are installed.\n"
