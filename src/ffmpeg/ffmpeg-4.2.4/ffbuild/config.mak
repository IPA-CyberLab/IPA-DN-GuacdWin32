...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/usr/local --enable-gpl --enable-nonfree --enable-postproc --enable-pthreads --enable-libmp3lame --enable-libx264 --enable-swscale --enable-avfilter --enable-avfilter --enable-libvorbis --enable-shared
prefix=/usr/local
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -U__STRICT_ANSI__ -D_XOPEN_SOURCE=600 -DZLIB_CONST
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-lgdi32 -lm -lvfw32 -lxcb -lxcb-shm
EXTRALIBS-avfilter=-pthread -lm
EXTRALIBS-swscale=-lm
EXTRALIBS-postproc=-lm
EXTRALIBS-avformat=-lm -lbz2 -lz -lsecur32
EXTRALIBS-avcodec=-pthread -liconv -lm -lz -lmp3lame -lm -lvorbis -lvorbisenc -lx264 -lole32 -luser32
