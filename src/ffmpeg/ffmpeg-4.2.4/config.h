...
#define FFMPEG_CONFIGURATION "--prefix=/usr/local --enable-gpl --enable-nonfree --enable-postproc --enable-pthreads --enable-libmp3lame --enable-libx264 --enable-swscale --enable-avfilter --enable-avfilter --enable-libvorbis --enable-shared"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2020
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "gcc 10 (GCC)"
